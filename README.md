...
The dataset holds organized sales transaction data spanning the 2011 operational year. It provides information on: • 🌍 **Markets** – Global sales results in Netherlands, Ireland, Germany, France, Australia, and over 30 additional countries. • 👥 **Customers** – Leading customer statistics showing fairly balanced revenue spread (the highest customer only 17-20% more than the runner-up). • 📦 **Products** – Sales details at the SKU level including quantities, unit costs, and product details for analyzing demand. • 💰 **Revenue & Sales** – Monthly KPIs indicating a base of $868.5K/month climbing to a $1.5M high in November 2011. • 📅 **Time Dimension** – Invoice dates facilitating trend tracking and seasonality identification during 2011.

## 📊 DASHBOARD EXPLANATION

### • Business Problem

The e-commerce firm functions in global markets encompassing different customer groups. Yet the top executives (CEO & CMO) encountered difficulties in determining: • Which areas generate the highest income and where growth prospects lie? • How does income vary month-to-month and is there a recognizable seasonal trend? • Who are the leading clients and does the company face concentration risk? • What are the worldwide demand trends and which markets are still underserved?

Relying on raw transaction data made it challenging to extract these insights swiftly and strategically.

### • Goal of the Dashboard

To deliver a data-centric Power BI dashboard that: • Integrates retail performance into one user-friendly platform. • Emphasizes revenue and sales metrics segmented by markets, customers, and products. • Facilitates time-series trend analysis over 2011 for seasonal forecasting. • Assists business executives in making decisions regarding growth strategy, customer loyalty, and stock management.
...
![Tata Online Retail Analytics Dashboard](screenshot.png)
